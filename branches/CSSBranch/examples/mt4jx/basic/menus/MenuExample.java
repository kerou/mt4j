...
import org.mt4j.css.util.CSSTemplates;
...
public class MenuExample  extends AbstractScene{
	...
	public MenuExample(MTApplication mtApplication, String name) {
		...
		this.app = mtApplication;
			...
			PImage p1 = app.loadImage("examples/p1.jpg");
			PImage p2 = app.loadImage("examples/p2.jpg");
			PImage p3 = app.loadImage("examples/p3.jpg");
