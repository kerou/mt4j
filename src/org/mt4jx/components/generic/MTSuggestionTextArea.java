...
public class MTSuggestionTextArea extends MTTextArea{
	...
	/* (non-Javadoc)
	 * @see org.mt4j.components.visibleComponents.widgets.MTTextArea#drawComponent(processing.core.PGraphics)
	 */
	@Override
	 ...
	 * The class that is interested in processing a edit
	...
	public class KeyboardListener implements StateChangeListener {
		...
		/* (non-Javadoc)
		 * @see org.mt4j.components.StateChangeListener#stateChanged(org.mt4j.components.StateChangeEvent)
		 */
		@Override
	...
	/**
	 * The listener interface for receiving suggestionBox events.
	 * The class that is interested in processing a suggestionBox
	 * event implements this interface, and the object created
	 * with that class is registered with a component using the
	 * component's <code>addSuggestionBoxListener<code> method. When
